...
<head>
    ...
    <link href='<?php echo get_template_directory_uri()."/css/screen.css" ?>' media='print' rel='stylesheet' type='text/css'/>
    <script src="<?php echo get_template_directory_uri()."/lib/shred.bundle.js" ?>"></script>
    ...
    <script src='<?php echo get_template_directory_uri()."/lib/handlebars-1.0.0.js" ?>' type='text/javascript'></script>
    ...
    <script src='<?php echo get_template_directory_uri()."/lib/swagger.js" ?>' type='text/javascript'></script>
    <script src='<?php echo get_template_directory_uri()."/lib/swagger-client.js" ?>' type='text/javascript'></script>
